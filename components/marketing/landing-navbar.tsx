    ...
    >
      <div className="mx-auto flex h-[4.5rem] max-w-7xl items-center justify-between gap-4 px-4 sm:px-6">
        ...
        <nav aria-label={en ? "Main navigation" : "التنقل الرئيسي"} className="hidden items-center gap-1 rounded-full border border-border/70 bg-card/70 p-1 text-sm font-medium lg:flex">
          ...
          <Link href="/pricing" className="rounded-full px-4 py-2 text-muted-foreground transition-all duration-200 hover:bg-primary/10 hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 dark:hover:text-indigo-300">
            {en ? "Pricing" : "الأسعار"}
          </Link>
        </nav>
