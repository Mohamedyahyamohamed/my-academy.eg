...
export function PortalParentView({ data }: { data: PortalDashboardData }) {
  ...
  const attendanceRate = data.attendance.length ? Math.round((attendanceCount / data.attendance.length) * 100) : 0;
