...
export function ChangePasswordForm() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    if (newPassword.length < 6) {
      toast.error(en ? "Password must be at least 6 characters." : "الباسورد لازم 6 حروف على الأقل");
      return;
    }
  ...
  return (
    <Card className="max-w-md">
      <CardHeader>
        ...
        <CardDescription>{en ? "Change your password. The new password must be at least 6 characters." : "غيّر الباسورد بتاعك. الباسورد الجديد لازم 6 حروف على الأقل."}</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={onSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder={en ? "At least 6 characters" : "6 حروف على الأقل"}
            />
          </div>
          <div className="space-y-1.5">
