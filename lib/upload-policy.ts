 ...
 *
 * Both lesson content and homework attachments accept files up to 500 MiB.
 * Large files must use the signed-upload path so they do not pass through a
 * Vercel Server Action request body. Server-side metadata validation remains
 * mandatory before a private storage object is committed to the database.
 */
